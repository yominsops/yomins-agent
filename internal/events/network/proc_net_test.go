...
const sampleTCPContent = `  sl  local_address rem_address   st tx_queue rx_queue tr tm->when retrnsmt   uid  timeout inode
   ...
   1: 0101007F:0035 00000000:0000 0A 00000000:00000000 00:00000000 00000000   101        0 23456 1 0000000000000000 100 0 0 10 0
...
func TestParseProcNetTCP_ListenOnly(t *testing.T) {
	...
	// Second listener: 127.0.0.1:53 (0101007F = 127.0.0.1, 0035 = 53)
	l1 := listeners[1]
